...
const Header = ({ setCollapsed, collapsed }) => {
  ...
  const { appTheme, toggleTheme } = PathmentorContext();
  ...
  return (
    <div className="shadow bg-white h-[9vh] flex items-center justify-between p-2 pr-3 pl-0 sticky top-0 z-50 w-full">
